...
class InformationController extends IndexController
{
    ...
    public function  index(Request $request)
    {
        ...
        if($request->get('catID')){
            ...
            if(!empty($seoConfig['seo_article']) && is_array($seoConfig['seo_article'])){
                ...
                $this->theme->setTitle('资讯中心');
                $this->theme->set('keywords','资讯中心,信息中心');
                $this->theme->set('description','资讯中心，资讯信息中心。');
            }
        }
    ...
    public function newsDetail($id)
    {
        ...
        if(!empty($info['seotitle'])){
            ...
            $this->theme->setTitle($info['title'].'|资讯信息中心');
            $this->theme->set('keywords',$info['title'].'，资讯中心');
            $this->theme->set('description','资讯中心'.$info['title'].'文章详情。');
        }
