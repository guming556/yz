...
class CashoutModel extends Model
{
    ...
    protected $fillable = [
            'uid', 'pay_type', 'pay_account', 'pay_code', 'cash', 'fees', 'real_cash', 'admin_uid', 'cashout_type', 'cashout_account', 'status', 'note', 'task_id', 'sn', 'new_order', 'total_pay_task', 'total_pay_task_actual', 'privilege_amount_sn', 'privilege_amount_task', 'work_offer_status_name', 'position_address', 'sn_title', 'boss_phone_num', 'worker_phone_num', 'worker_name', 'bank_name', 'user_type_name','sub_order_index_id'
        ];
