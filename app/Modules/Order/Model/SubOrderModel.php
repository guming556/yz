...
class SubOrderModel extends Model
{
    ...
    protected $fillable = ['title','note','cash','uid','order_id','order_code','product_id','product_type','status','created_at','updated_at','task_id', 'project_type','fund_state','is_auxiliary'];
