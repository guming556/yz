...
Route::get('user/getZoneByCoordinate', 'AuthController@getZoneByCoordinate')->name('zoneDetailByCoordinate');

//手机端注册页面
Route::get('user/regByMobile/{code}', 'IndexController@regByMobile')->name('regByMobile');
...
Route::group(['prefix' => 'user', 'middleware' => 'auth'], function () {
    ...
    //设计师提交初步设计图纸
    Route::post('/designerSubImg', 'UserCenterController@designerSubImg')->name('designerSubImg');

    //设计师提交深化图纸
    Route::post('/designerSubDeepImg', 'UserCenterController@designerSubDeepImg')->name('designerSubDeepImg');
