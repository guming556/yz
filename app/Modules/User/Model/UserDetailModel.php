...
class UserDetailModel extends Model
{
    ...
    protected $fillable = [
        'uid', 'realname', 'avatar', 'mobile', 'qq', 'wechat', 'card_number', 'province', 'city', 'area', 'address', 'sign', 'balance', 'balance_status', 'last_login_time', 'alternate_tips', 'nickname', 'publish_task_num', 'receive_task_num', 'employer_praise_rate', 'employee_praise_rate','lat','lng','tag','introduce','experience','tag','work_type','star','cost_of_design','user_age','native_place','demo','score','serve_area_id'
    ];
