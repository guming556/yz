...
<form class="form-horizontal" role="form" method="post" action="{!! url('manage/payConfig') !!}">
    ...
    <div class="g-backrealdetails clearfix bor-border interface">
        <!-- PAGE CONTENT BEGINS -->
            ...
            <div class="form-group interface-bottom col-xs-12">
                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">家装保险价格</label>
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-10 col-sm-4" name="cash[insurance]"
                           value="@if(isset($data['insurance'])){!! $data['insurance'] !!}@endif">
                    <span class="help-inline col-xs-12 col-sm-8">
                        <span class="middle">（单位：元）</span>
                    </span>
                </div>
            </div>
            <div class="form-group interface-bottom col-xs-12 hide">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-10 col-sm-4" name="cash[per_charge]"
                           value="0" placeholder="@if(isset($data['per_charge'])){!! $data['per_charge'] !!}@endif">
                    <span class="help-inline col-xs-12 col-sm-8">
            ...
            <div class="form-group interface-bottom col-xs-12 hide">
                ...
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-10 col-sm-4" name="cash[per_low]"
                           value="0" placeholder="@if(isset($data['per_low'])){!! $data['per_low'] !!}@endif">
                    <span class="help-inline col-xs-12 col-sm-8">
                        <span class="middle">（用户提现单笔收费最低金额。少于200的提现以此为收费标准）</span>
                    </span>
                </div>
            </div>
            <div class=" interface-bottom col-xs-12 hide">
                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">单笔最高收费</label>
                <div class="col-sm-9">
                    <input type="text" id="form-field-1" class="col-xs-10 col-sm-4" name="cash[per_high]" value="0" placeholder="@if(isset($data['per_high'])){!! $data['per_high'] !!}@endif">
                    <span class="help-inline col-xs-12 col-sm-8">
                        <span class="middle">（单位：元）</span>
                    </span>
                </div>
