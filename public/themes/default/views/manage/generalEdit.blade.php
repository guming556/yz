...
<form class="form-horizontal registerform" role="form" action="{!! url('manage/savegeneral') !!}" method="post">
    {!! csrf_field() !!}
    <div class="g-backrealdetails clearfix bor-border">
        ...
        <div class="bankAuth-bottom clearfix col-xs-12">
            <p  class="col-sm-1 control-label no-padding-left">用户列表：</p>
            <div class="col-sm-5">
                <div class="row">
                    <p class="col-sm-6">
                        <select name="use_type" id="use_type" class="form-control validform-select Validform_error">
                            <option value="0">请选择用户类型</option>
                            <option value="1">业主</option>
                            <option value="2">设计师</option>
                            <option value="3">管家</option>
                            <option value="4">监听</option>
        ...
        <div class="bankAuth-bottom clearfix col-xs-12">
            ...
            <div class="col-sm-5">
                <div class="row">
                    <p class="col-sm-6">
                        <select name="role_name" id="role_name" class="form-control validform-select Validform_error">
