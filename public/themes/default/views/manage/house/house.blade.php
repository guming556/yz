   ...
   {{-- <div class="space-2"></div>
    ...
    <h3 class="header smaller lighter blue mg-bottom20 mg-top12">户型管理</h3>
    <form action="{{ URL('manage/houseCreate') }}" method="post" id="form-data">
        {{ csrf_field() }}
...
<script>
    ...
    function area_create(obj)
    {
        ...
        //添加一个地区的input框
        var html = "<tr area_id=\""+id+"\" id=\"area-delate-"+id+"\"><td class=\"text-left\"><input type=\"text\" name=\"name["+id+"]\" value=\"\" area_id=\""+id+"\"  onchange=\"area_change($(this))\"><\/td><td class=\"text-left hide\"><input type=\"text\" name=\"sort["+id+"]\" value=\"\" area_id=\""+id+"\"  onchange=\"area_change($(this))\"><\/td><td width=\"40%\"><\/td><\/tr>" ;
