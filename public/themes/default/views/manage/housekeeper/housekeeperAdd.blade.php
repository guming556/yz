...
<form class="form-horizontal registerform" role="form" action="{!! url('manage/housekeeperDataInsert') !!}" method="post" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="g-backrealdetails clearfix bor-border">
        ...
        <div class="bankAuth-bottom clearfix col-xs-12">
            ...
            {{--<p class="col-sm-5">--}}
                {{--<input multiple="" type="file" name="head_img" id="head_img" />--}}
            {{--</p>--}}
        ...
        <div class="bankAuth-bottom clearfix col-xs-12">
            <p class="col-sm-1 control-label no-padding-left" for="cost_of_design"> 管家星级：</p>
            <p class="col-sm-2">
                <select class="form-control" name="workStar" id="workStar">
                @for($i=1;$i<=5;$i++)
                      <option value="{!! $i !!}" >{!! $i !!}星</option>
                @endfor
                </select>
                {{--<input type="text" id="cost_of_design"  class="col-xs-10 col-sm-5" name="cost_of_design" datatype="*" value="">--}}
                <!-- <span class="help-inline col-xs-12 col-sm-7"><i class="light-red ace-icon fa fa-asterisk"></i></span> -->
            </p>
        </div>
        <div class="bankAuth-bottom clearfix col-xs-12">
        ...
        {{--<div class="bankAuth-bottom clearfix col-xs-12">--}}
            {{--<p class="col-sm-1 control-label no-padding-left" for="realname"> 现住地址：</p>--}}
            {{--<p class="col-sm-4">--}}
                {{--<textarea type="text" name="demo" id="demo"  class="col-xs-10 col-sm-5" value=""></textarea>--}}
            {{--</p>--}}
        {{--</div>--}}
        ...
        <div class="bankAuth-bottom clearfix col-xs-12">
            ...
            <p class="col-sm-4">
                <input type="text" name="detail_address" id="form-field-1"  class="col-xs-12 col-sm-12" value="{{old('detail_address')}}">
            </p>
            <p class="col-sm-4">
