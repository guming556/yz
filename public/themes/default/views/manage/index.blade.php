                ...
                <div class="col-sm-3 infobox-container">
                    ...
                    <div class="infobox infobox-green clearfix" style="width: 100%;">
                        ...
                        <div class="infobox-data">
                            ...
                            <div class="infobox-content">会员数（人）</div>
                        </div>
                ...
                <div class="col-sm-3 infobox-container">
                    ...
                    <div class="infobox infobox-blue" style="width: 100%;">
                        ...
                        <div class="infobox-data">
                            ...
                            <div class="infobox-content">订单数（条）</div>
                        </div>
                                    ...
                                    <div class="infobox-container">
                                        ...
                                        <div class="infobox infobox-orange2">
                                            ...
                                            <div class="infobox-data">
                                                ...
                                                <div class="infobox-content">完成的订单</div>
                                            </div>
                                        </div>
                                        <div class="infobox infobox-orange2">
                                            <!-- #section:pages/dashboard.infobox.sparkline -->
                                            ...
                                            <div class="infobox-data">
                                                ...
                                                <div class="infobox-content">失败的订单</div>
                                            </div>
                                        </div>
                                        <div class="infobox infobox-orange2">
                                            <!-- #section:pages/dashboard.infobox.sparkline -->
                                            ...
                                            <div class="infobox-data">
                                                ...
                                                <div class="infobox-content">进行的订单</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="widget-main clearfix padding-14">
                                ...
                                <div class="infobox-container">
                                    ...
                                    <div class="infobox infobox-orange2">
                                        ...
                                        <div class="infobox-data">
                                            <span class="infobox-data-number">{!! $topCount['todayUser'] !!}</span>
                                            <div class="infobox-content">今日会员数</div>
                                        </div>
                ...
                <div class="col-sm-6">
                    <div class="widget-box">
                        <div class="widget-header widget-header-flat">
                            <h5 class="widget-title"><i class="fa fa-clock-o"></i> 订单时间提醒</h5>
                            ...
                            <div class="widget-main" style="height:271px;">
                                <div class="table-responsive">
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <th class="center">
                                                <i class="fa fa-caret-right"></i> 订单名称
                                            </th>
                                            <th>
                                                <i class="fa fa-caret-right"></i> 订单金额
                                            </th>
                                            <th>
                                                <i class="fa fa-caret-right"></i> 订单状态
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
