...
<form class="form-horizontal registerform" role="form" action="{!! url('manage/laborDataInsert') !!}" method="post" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="g-backrealdetails clearfix bor-border">
        ...
        <div class="bankAuth-bottom clearfix col-xs-12">
            ...
            <div class="bankAuth-bottom clearfix col-xs-12">
                <p  class="col-sm-1 control-label no-padding-left">工人星级：</p>
                <div class="col-sm-5">
                    <div class="row">
                        <p class="col-sm-4">
                            <select name="workStar" id="workStar" class="form-control validform-select Validform_error">
                                @for($i=1;$i<=5;$i++)
