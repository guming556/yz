...
<div class="widget-header mg-bottom20 mg-top12 widget-well">
    <div class="widget-toolbar no-border pull-left no-padding">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="/advertisement/adList">作品列表</a>
            </li>
        </ul>
    </div>
</div>
        ...
        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
            ...
            @foreach($goods as $good )
                <tr>
                    ...
                    <td class="center">
                        <img id="imgShow1" width="120" height="120" src="{{url($good->cover)}}"/>
                    </td>
                    <td class="center">
                        {!! $good->title !!}
                    </td>
                    ...
                    <td class="center">
                        <div class="hidden-sm hidden-xs btn-group">
                            ...
                            <a title="编辑版块" class="btn btn-xs btn-info"
                               href="/manage/editSection/{!! $good->id !!}/{!! $workder_id !!}">
...
<div class="row">
    <div class="col-xs-12">
        <div class="dataTables_info row" id="sample-table-2_info" role="status" aria-live="polite">
            <a href="/manage/addWorkGoods/{!! $workder_id !!}">
                <button class="btn btn-sm btn-primary">添加作品</button>
            </a>
        </div>
    </div>
