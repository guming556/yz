<div>
    <div>
        <div>
            ...
            <form class="form-horizontal" action="/manage/saveProject" method="post">
                {!! csrf_field() !!}
                        ...
                        <div class="g-backrealdetails clearfix bor-border">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <div class="ace-spinner touch-spinner" style="width: 100px;"><div class="input-group">
                                                <input type="text" id="spinner3" name="complete" value="" class="input-mini spinner-input form-control"  maxlength="3">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <textarea name="content" cols="30" rows="10" class="col-sm-6"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-right">排序：</td>
                                    <td class="text-left">
                                        <input type="text" name="listorder" class="col-sm-6" value="0">
                                    </td>
                                </tr>
                                <tr>
