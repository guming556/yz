   ...
   {{-- <div class="space-2"></div>
    ...
    <h3 class="header smaller lighter blue mg-bottom20 mg-top12">空间管理</h3>
    <form action="{{ URL('manage/spaceCreate') }}" method="post" id="form-data">
        {{ csrf_field() }}
