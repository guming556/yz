...
<form class="form-horizontal registerform" role="form" action="{!! url('manage/supervisorInfoInsert') !!}" method="post" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="g-backrealdetails clearfix bor-border">
        ...
        {{--<div class="bankAuth-bottom clearfix col-xs-12 hide">--}}
            ...
            {{--<p class="col-sm-5">--}}
                {{--<input type="text" id="cost_of_design"  class="col-xs-10 col-sm-5" name="cost_of_design" datatype="*" value="50">--}}
                {{--<!-- <span class="help-inline col-xs-12 col-sm-7"><i class="light-red ace-icon fa fa-asterisk"></i></span> -->--}}
            {{--</p>--}}
        {{--</div>--}}
        <div class="bankAuth-bottom clearfix col-xs-12">
            <p class="col-sm-1 control-label no-padding-left" for="star"> 星级：</p>
            <p class="col-sm-2">
