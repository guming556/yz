                                                ...
                                                <table class="table table-hover mg-bottom0">
                                                    <form action="/manage/baseConfig" method="post" >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text"  placeholder="悬赏订单" name="name" value="{{ $model_data['name'] }}" class="col-xs-10 col-sm-2">
                                                            </td>
                                                        </tr>
                                                        <tr>
                        ...
                        <div id="flow" class="tab-pane {{ ($id==1)?'active row':'' }}">
                            <form action="/manage/taskConfigUpdate" method="post">
                                ...
                                <div class="col-sm-8 flow-task">
                                    <div class="widget-box">
                                        <div class="widget-header widget-header-flat">
                                            <h5 class="widget-title">订单佣金策略：订单规则设置和异常订单资金分配</h5>
                                        </div>
                                        <div class="widget-body">
                                            <div class="widget-main row paddingTop">
                                                <div class="table-responsive">
                                                    <table class="table table-hover mg-bottom0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="col-sm-3 flow-money text-right">订单审核金额设定：</td>
                                                            <td> <input type="text" name="{{ $config['task_bounty_limit']['id'] }}" value="{{ $config['task_bounty_limit']['rule'] }}" class="change_ids"> 元(发布赏金低于该设定金额的订单需要审核，设为0即无限制)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="col-sm-3 flow-money text-right">订单最大金额设定：</td>
                                                            <td> <input type="text" name="{{ $config['task_bounty_max_limit']['id'] }}" value="{{ $config['task_bounty_max_limit']['rule'] }}" class="change_ids"> 元(设置订单最大金额,为0时不生效)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="col-sm-3 flow-money text-right">订单最小金额设定：</td>
                                                            <td> <input type="text" name="{{ $config['task_bounty_min_limit']['id'] }}" value="{{ $config['task_bounty_min_limit']['rule'] }}" class="change_ids"> 元(设置订单最小金额不得小于0元)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="col-sm-3 flow-money text-right">订单提成比例：</td>
                                                            <td> <input type="text" name="{{ $config['task_percentage']['id'] }}" value="{{ $config['task_percentage']['rule'] }}" class="change_ids"> %(站长提取订单佣金的百分比，设为0即无抽佣)</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="col-sm-3 flow-money text-right">订单失败返金抽成比例：</td>
                                                            <td> <input type="text" name="{{ $config['task_fail_percentage']['id'] }}" value="{{ $config['task_fail_percentage']['rule'] }}" class="change_ids"> 元(发布赏金低于该设定金额的订单需要审核，设为0即无限制)</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                    ...
                                                    <div>
                                                        <lable>
                                                            ...
                                                            <select name="{{ $config['task_sys_help_rule']['id'] }}" class="change_ids">
                                                                ...
                                                                <option value="3" {{ ($config['task_sys_help_rule']['rule']==3)?'selected':'' }}>参与订单次数</option>
                                                            </select>
                                                        </lable>
                                                        <br><br>
                                                    </div>
                                            ...
                                            <div class="widget-main row paddingTop">
                                                <div class="table-responsive">
                                                    <table class="table table-hover mg-bottom0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="col-sm-2 flow-money text-right">订单交稿截止时间最大规则：</td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td class="col-sm-2 flow-money text-right">订单公示期：</td>
                                                        ...
                                                        <tr>
                                                            <td class="col-sm-2 flow-money text-right">订单交稿截止最小天数：</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <input type="text" name="{{ $config['task_delivery_max_time']['id'] }}" value="{{ $config['task_delivery_max_time']['rule'] }}" class="change_ids"> 天  （逾期未完成交付，订单直接冻结交由管理员处理）</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="col-sm-2 flow-money text-right">验收期最大时间限制：</td>
                                                            <td> <input type="text" name="{{ $config['task_check_time_limit']['id'] }}" value="{{ $config['task_check_time_limit']['rule'] }}" class="change_ids"> 天  （逾期未验收的，订单稿件直接通过验收阶段）</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                        ...
                        <div id="power" class="tab-pane {{ ($id==2)?'active row':'' }}">
                            ...
                            <div class="col-sm-12 power-chunk">
                                <div class="col-sm-6 power-buy">
                                    <div class="widget-box">
                                        <div class="widget-header widget-header-flat">
                                            <h5 class="widget-title">发布订单　　买家（雇主）</h5>
                                        </div>
                                        <div class="widget-body">
