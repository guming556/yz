...
<form class="form-horizontal registerform " role="form" action="{!! url('manage/userEdit') !!}" method="post" enctype="multipart/form-data">
	...
	<div class="g-backrealdetails clearfix bor-border">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 身份证正面</p>
			<div class="container col-sm-3" id="crop-front-img">
				<div class="avatar-view text-left" title="Change the card front" id="card-div">
					@if(!empty($info['card_front_side']))
						<img src="{!!  url($info['card_front_side']) !!}" style="height: 100%" alt="Avatar">
					@else
						<img src="/themes/default/assets/images/default_avatar.png" style="height: 100%" alt="Avatar">
					@endif
				</div>
				<input type="hidden" name="card_front_side" id="card_front_side" value="{!! $info['card_front_side'] !!}" />
			</div>
		</div>
		{{--<div class="bankAuth-bottom clearfix col-xs-12">--}}
			{{--<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 身份证正面</p>--}}
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-5">
				<input type="text" id="cost_of_design"  class="col-xs-10 col-sm-5" name="cost_of_design" datatype="*" value="{!! $info['cost_of_design'] !!}">
				<!-- <span class="help-inline col-xs-12 col-sm-7"><i class="light-red ace-icon fa fa-asterisk"></i></span> -->
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
				...
				<div class="row">
					<p class="col-sm-4">
						<select name="star" id="star" class="form-control validform-select Validform_error" disabled="disabled">
							@for($i=1;$i<=5;$i++)
								<option value="{!! $i !!}" @if($i==$info['star'])selected="selected"@endif>{!! $i !!}星</option>
							@endfor
						</select>
					</p>
				</div>
		...
		{{--<div class="bankAuth-bottom clearfix col-xs-12">--}}
			...
			{{--<div class="container col-sm-2" >--}}
				{{--<div class="text-left" title="Change the card image" >--}}
					{{--@if(!empty($info['card_front_side']))--}}
						{{--<img src="{!! $info['card_front_side'] !!}" style="width: 320px" >--}}
					{{--@endif--}}
		...
		{{--</div>--}}
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 身份证反面</p>
			<div class="container col-sm-2" >
				<div class="text-left" title="Change the card image" >

					@if(!empty($info['card_back_dside']))
						<img src="{!! $info['card_back_dside'] !!}" style="width: 320px" style="float: left">
					@endif
		...
		{{--<div class="bankAuth-bottom clearfix col-xs-12">--}}
			...
			{{--<div class="container col-sm-2" >--}}
				{{--<div class="text-left" title="Change the card image" >--}}
					{{--<input multiple="" type="file" name="card_back_dside" id="card_back_side" />--}}
				{{--</div>--}}
			{{--</div>--}}
		{{--</div>--}}
...
{!! Theme::asset()->container('custom-js')->usePath()->add('card-js', 'js/doc/card.js') !!}
