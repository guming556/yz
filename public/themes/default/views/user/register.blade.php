                            ...
                            <div class="widget-main loginmain bor-radius2 loginmain-container">
                                ...
                                <div id="phone" class="tab-pane fade">
                                    <form class="registerform" action="{!! url('register') !!}" method="post">
                                        ...
                                        <label class="block clearfix">
                                        <span class="block input-icon input-icon-right">
                                            <input type="text" class="form-control inputxt" name="username" id="username" placeholder="常用手机号码" ajaxurl="{!! url('checkUserName') !!}" datatype="m" nullmsg="请输入手机号" errormsg="手机号格式错误！">
                                        ...
                                        <div class="task-casebghid no-padding-left">
                                            ...
                                            <input type="button" class="btn btn-white btn-primary c-btntime" value="获取验证码" id="btnSendCode">
